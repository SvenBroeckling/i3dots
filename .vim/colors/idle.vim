...
" Syntax group
highlight Comment    gui=none guifg=red     guibg=bg      ctermfg=2
highlight Constant   gui=none guifg=#900090 guibg=bg      ctermfg=White
highlight Error      gui=none guifg=red     guibg=#4040ff term=reverse        ctermbg=Red    ctermfg=White
highlight Identifier gui=none guifg=blue    guibg=bg      ctermfg=Green
highlight Ignore     gui=none guifg=bg      guibg=bg      ctermfg=black
highlight PreProc    gui=none guifg=orange  guibg=bg      ctermfg=Green
highlight Special    gui=none guifg=#8040f0 guibg=bg      ctermfg=DarkMagenta
highlight Statement  gui=none guifg=orange  guibg=bg      ctermfg=White
highlight Todo       gui=none guifg=black   guibg=white   term=standout       ctermbg=Yellow ctermfg=Black
highlight Type       gui=bold guifg=black   guibg=bg      ctermfg=LightGreen
highlight Underlined gui=none guifg=blue    guibg=bg
highlight String     gui=none guifg=green   guibg=bg      ctermfg=Yellow
highlight Number     gui=none guifg=blue    guibg=bg      ctermfg=White
